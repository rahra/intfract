**Please note that there is a multi-threaded variant in the [development branch](https://github.com/rahra/intfract/tree/multithread) which makes use of multi-cores which gives an additional speed-up!**
